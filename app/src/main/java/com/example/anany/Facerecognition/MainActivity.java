package com.example.anany.Facerecognition;
...
public class MainActivity extends AppCompatActivity {
    ...
    String app_id = "df3b83e6";
    String api_key = "103549c77691d37b12aa957731a5c647";
    //IMPORTANT ------------------------------------------------------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        identlistener = new KairosListener() {
            @Override
            public void onSuccess(String response) {
                System.out.println("RRRRRRRRRRRRRRRRR111  "+readJSONForName(response));
                if(!TextUtils.isEmpty(readJSONForName(response))) {
                    makeToast("Success! You are: " + readJSONForName(response));
                    info.setText(readJSONForName(response));
                }else{
                    makeToast("No face recognized");
                    info.setText("No face recognized");
                }
            }
...
//            String path = Environment.getExternalStorageDirectory()+ "/22222.jpg";
